        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-6">
          ...
          <div className="md:col-span-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
              {/* Suivez-nous section */}
              <div>
                <h3 className="font-lora text-md text-deep-black mb-2">Suivez-nous</h3>
                <div className="flex space-x-2">
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                    <img src={instagramLogo} alt="Instagram" className="w-7 h-7 rounded-sm" />
                  </a>
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                    <img src={facebookLogo} alt="Facebook" className="w-7 h-7 rounded-sm" />
                  </a>
                </div>
              </div>
              ...
              {/* Réservez section */}
              <div>
                <h3 className="font-lora text-md text-deep-black mb-2">Réservez sur</h3>
                <div className="flex flex-wrap gap-2">
                  ...
                  <a href="https://booking.com" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-md shadow-sm hover:shadow-md transition-shadow duration-300">
                    <img src={bookingLogo} alt="Booking.com" className="h-4" />
                  </a>
                  <a href="https://agoda.com" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-md shadow-sm hover:shadow-md transition-shadow duration-300">
                    <img src={agodaLogo} alt="Agoda" className="h-4" />
                  </a>
                  <a href="https://trip.com" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-md shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          {/* Deuxième et troisième colonnes - Contact et Legal côte à côte */}
          <div className="md:col-span-7">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
              {/* Contact section */}
              <div>
                <h3 className="font-lora text-md text-deep-black mb-2">Contact</h3>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2">
                    ...
                    <span className="text-gray-600 text-sm">Jl. Petitenget No.XX, <br />Seminyak, Kuta Utara, <br />Bali, Indonesia</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-4 h-4 text-emerald mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <a href="mailto:info@villaorea.com" className="text-gray-600 hover:text-emerald transition-colors duration-300 text-sm">info@villaorea.com</a>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-4 h-4 text-emerald mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                    <a href="tel:+6281234567890" className="text-gray-600 hover:text-emerald transition-colors duration-300 text-sm">+62 812 3456 7890</a>
                  </li>
                </ul>
              </div>
              ...
              {/* Legal section */}
              <div>
                <h3 className="font-lora text-md text-deep-black mb-2">Legal</h3>
                <ul className="space-y-1">
                  ...
                  <li><a href="#" className="text-gray-600 hover:text-emerald transition-colors duration-300 text-sm">{t.footer.cookiePolicy}</a></li>
                </ul>
              </div>
            </div>
          </div>
