          ...
          <div className="md:col-span-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <a href="https://www.airbnb.com/l/7icncLgD" target="_blank" rel="noopener noreferrer" className="bg-white p-1 rounded-md shadow-sm hover:shadow-md transition-shadow duration-300">
