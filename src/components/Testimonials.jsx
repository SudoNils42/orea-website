        ...
        <div className="max-w-4xl mx-auto relative" data-aos="fade-up">
          ...
          <div className="overflow-hidden relative min-h-[250px]">
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                <div className="bg-gradient-to-br from-emerald/20 to-pure-white/5 p-8 md:p-10 rounded-lg text-center">
                  <div className="mb-6">
                  ...
                  <blockquote className="font-lora text-lg md:text-xl italic text-gray-200 mb-6">
