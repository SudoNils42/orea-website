  ...
  return (
    ...
    >
      <div className="container mx-auto px-2 sm:px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 z-20">
          <LanguageSelector />
          <button 
            className={`flex flex-col justify-center items-center w-9 sm:w-10 h-10 ${isMenuOpen ? 'hamburger-active' : ''}`} 
            onClick={toggleMenu}
